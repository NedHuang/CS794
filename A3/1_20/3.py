...
with open('iterations_gd_1_20.csv', mode='w') as iteration_file:
...
with open('iterations_accelerated_gd_1_20.csv', mode='w') as iteration_file:
    iteration_writer = csv.writer(iteration_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
