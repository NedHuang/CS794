...
with open('iterations_gd_20_40.csv', mode='w') as iteration_file:
...
with open('iterations_accelerated_gd_20_40.csv', mode='w') as iteration_file:
    iteration_writer = csv.writer(iteration_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
