...
max_interation_q7 = 100
iterations_gd = []
iterations_accelerated_gd = []
for mu_ in range(1,30,5):
    print(mu_)
    x_list_q1, denoise_result_q1, iterations_q1 = gradient_descent_armijo(x0, epsilon, lambda_, max_iterations, gamma_, mu_,clean_image)
    x_list_q5, denoise_result_q5, iteration_q5 = gradient_descent_q5(x0, epsilon, lambda_, max_iterations, gamma_, mu_, z_clean)
...
fig = plt.figure(figsize=(8, 6))
plt.plot(iterations_gd, label=("Armijo"), linewidth=2.0, color ="black")
plt.plot(iterations_accelerated_gd, label=("Accelerated + Armijo"), linewidth=2.0, color ="blue")
